...
class AppColors {
  ...
  static const Color accent = Color(0xFFBA9A73); // Accent color for buttons, icons, etc.
  static const Color accentDark = Color(0xFFBA9A73); // Dark version of the accent color for buttons, icons, etc.
  static const Color accentLight = Color(0xFFF5ECDC); // Light version of the accent color for elements like buttons, cards, etc.
